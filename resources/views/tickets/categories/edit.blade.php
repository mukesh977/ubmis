		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<h3 class="box-title">Edit {{ $categories->name }}'s Category</h3>
				</div>
				<div class="box-body table-responsive no-padding">
					<form method="post" action="{{ url('admin/categories/'.$categories->id) }}" method="post">
						@csrf
						@method('put');
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input type="color" name="color" value="{{ (old('color')? old('color'): $categories->color) }}" class="form-control">
								<span class="form-text text- ">If you select red color  then categories name will be displayed in red color.</span>
							</div>
						</div>
						<!-- /.box-body -->
