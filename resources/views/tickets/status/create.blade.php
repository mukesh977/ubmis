...
@section('title', 'Ultrabyte | Create Status')
		...
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					...
					<h3 class="box-title">Create New Tickets</h3>
				</div>
				<div class="box-body table-responsive no-padding">
					{{-- <form method="post" action="{{ url('admin/status ') }}" method="post"> --}}
					<form method="post" action="#" method="post">
						@csrf
						<div class="box-body">
							<div class="form-group">
								<label for="exampleInputPassword1">Status Name</label>
								<input type="text" class="form-control" id="exampleInputPassword1" name="name" autofocus>
								@if($errors->has('name'))
