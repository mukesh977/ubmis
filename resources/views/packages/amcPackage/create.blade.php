...
@section('title', 'Ultrabyte | Add AMC Attribute')
			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
					<div class="box-header with-border" style="display: flex;">
						<h3 class="box-title">Add AMC Attribute</h3>
					...
					<div class="box-body">
						<form method="post" action="{{ url('/admin/amc-package') }}">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group" id="form-group-name">
							          ...
							          <input type="text" name="amcAttributeName" id="amcAttributeName" placeholder="Enter AMC Attribute Name" class="form-control" value="">
						    ...
						    <div class="row">
								<div class="col-md-12">
									<input class="btn btn-primary pull-right" type="submit" value="Add AMC Attribute"> 
								</div>
							</div>
