<?php $sn = ($searchedCompanies->currentPage()-1)*($searchedCompanies->perPage()); ?>
	...
	@endif
		...
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Searched Company</h3>
			...
			<div class="box-body table-responsive no-padding">
				...
				@if( $searchedCompanies->total() > $searchedCompanies->perPage() )
					{{ $searchedCompanies->links('layouts.paginator') }}
		        @else
