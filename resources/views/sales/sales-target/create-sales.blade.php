	...
	<div class="row">
		<div class="col-xs-12 col-md-12">
			<div class="box box-success">
				...
				<div class="box-body">
					<form role="form" id="sales-form" method="POST" action="{{route('users-sales.store')}}">
						{{csrf_field()}}
						<div class="box-body">
							...
							<div class="form-group {{ $errors->has('total_sales') ? ' has-error' : '' }}">
								...
								<input type="text" name="total_sales" id="total_sales" class="form-control" placeholder="e.g. 10000" value="{{ old('total_sales') }}">
