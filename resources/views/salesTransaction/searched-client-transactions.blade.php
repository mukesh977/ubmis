	...
	<section class="content">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Searched Client Transactions</h3>

				<div class="box-tools">
					<form method="get" action="{{ url('/client-transactions/search') }}">
						<div class="input-group input-group-sm" style="width: 150px;">
							<input type="text" name="companyName" class="form-control pull-right" value="{{ !empty($searchedWord)? $searchedWord : '' }}" placeholder="Search">
				...
				<table class="table table-hover">
					...
					@foreach( $results as $result )
						...
						<tr>
							...
							<td>
								{{ !empty($result['totalAmount'])? $result['totalAmount'] : '' }}
							</td>

							<td>
								{{ !empty($result['totalPaidAmount'])? $result['totalPaidAmount'] : '' }}
							</td>

							<td>
								{{ !empty($result['totalUnpaidAmount'])? $result['totalUnpaidAmount'] : '' }}
							</td>
