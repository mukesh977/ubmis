<?php $sn = ($listShops->currentPage()-1)*($listShops->perPage()); ?>
	...
	@endif
		...
		<div class="box">
				...
				<div class="box-tools">
					<form method="get" action="{{ url('/admin/list-shop/search') }}">
						<div class="input-group input-group-sm" style="width: 150px;">
							<input type="text" name="shopName" class="form-control pull-right" placeholder="Search">
			...
			<div class="box-body table-responsive no-padding">
				...
				@if( $listShops->total() > $listShops->perPage() )
					{{ $listShops->links('layouts.paginator') }}
		        @else
