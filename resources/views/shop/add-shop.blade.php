...
@section('title', 'Ultrabyte | Add Shop')
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-body">
						<form method="post" action="{{ url('/admin/store-shop') }}">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-12">
									@if(empty($editShop->id))
										<input class="btn btn-primary pull-right" type="submit" value="Add Shop"> 
									@else
